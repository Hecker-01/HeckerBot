    ...
    if (interaction.isChatInputCommand()) {
      ...
      if (!command) {
        const Error = new EmbedBuilder()
          .setTitle(
            "<:icons_coloredwrong:1208356610909667349> Oops an internal error occurred!"
          )
      ...
      if (command.developer && interaction.user.id !== client.config.ownerID) {
        const Error = new EmbedBuilder()
          .setTitle(
            "<:icons_coloredwrong:1208356610909667349> You do not have permission to use this command!"
          )
          .setDescription(
      ...
      if (interaction.customId === "verify") {
        if (interaction.member.roles.cache.has("1208342791273586710")) {
          ...
          const unable = new EmbedBuilder()
            .setTitle(
              "**<:icons_coloredwrong:1208356610909667349> You could not be verified!**"
            )
            .setDescription(
